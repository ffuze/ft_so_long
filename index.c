...
/*   Updated: 2025/02/24 16:20:42 by adegl-in         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// int		check_actual_character(t_game *game, int new_x, int new_y)
// {
...
int move_player(t_game *game, int new_x, int new_y)
{
    ...
    if (game->map.grid[new_y][new_x] == 'E')
    {
		...
		ft_printf("score: %d ----- total score: %d\n", game->calcs.score, game->calcs.total_score);
        return (0);
    }
...
int main(int argc, char **argv)
{
	...
	{
		ft_printf("La mappa che hai inserito non e' valida\n");
		return (1);
	}
	load_textures(&game);
